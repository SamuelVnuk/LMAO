        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="">
                ...
                <input type="text" name="username" class="<?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>"
                    value="<?php echo $username; ?>" placeholder="Viliam">
                <br><span class=""><?php echo $username_err; ?></span>
            </div>
            <div class="">
                ...
                <br><span class=""><?php echo $password_err; ?></span>
            </div>
            <div class="">
                <label>Confirm Password</label>
                <input type="password" name="confirm_password"
                    class="<?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>"
                    value="<?php echo $confirm_password; ?>" placeholder="heslo123">
                <br><span class=""><?php echo $confirm_password_err; ?></span>
            </div>
            <div class="">
